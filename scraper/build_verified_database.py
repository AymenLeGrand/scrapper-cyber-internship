...
# -------------------------------------------------------------
# 1. SYNACKTIV (4 active verified website offers)
# -------------------------------------------------------------
synacktiv_entries = [
    {
        "id": "synacktiv_rex_kraqozorus",
        "title": "STAGE M2 / PFE - Recycle Rex : Password Recycling in Kraqozorus",
        ...
        "domain": "Cryptology",
        "all_domains": ["Cryptology", "Cyber Offensive / Hardware / Pentest"],
        "is_crypto": True,
        "is_cyber": True,
        "source": "Synacktiv (Site Officiel)",
        "description": "Amélioration des fonctionnalités de recyclage et analyse cryptographique de mots de passe au sein de l'outil Kraqozorus de Synacktiv (R&D offensive, Active Directory, hash cracking). Gratification : 1 800 € brut / mois.",
    ...
    },
    {
        ...
        "title": "STAGE M2 / PFE - DataForge System !",
        "company_id": "synacktiv",
        "company_name": "Synacktiv",
        "contract_type": "Stage M2 / PFE (6 mois)",
        "location": "Paris / Rennes, France",
        ...
        "all_domains": ["Cyber Offensive / Hardware / Pentest", "Cloud / GRC / DevSecOps"],
        "is_crypto": False,
        "is_cyber": True,
        "source": "Synacktiv (Site Officiel)",
        "description": "Conception et développement d'un système de génération automatique de données d'utilisation réalistes (mails, documents, navigation) pour la validation et l'entraînement d'outils d'investigation et d'évaluation. Gratification : 1 800 € brut / mois.",
    ...
    },
    {
        ...
        "title": "STAGE M2 / PFE - Hook me if you can !",
        "company_id": "synacktiv",
        "company_name": "Synacktiv",
        "contract_type": "Stage M2 / PFE (6 mois)",
        "location": "Paris / Rennes, France",
        ...
        "domain": "Cyber Offensive / Hardware / Pentest",
        "all_domains": ["Cyber Offensive / Hardware / Pentest", "Reverse Engineering"],
        "is_crypto": False,
        "is_cyber": True,
        "source": "Synacktiv (Site Officiel)",
        "description": "Conception et développement d'outils d'analyse et d'interception d'API (hooking) sur plates-formes Apple (macOS / iOS) au profit des équipes d'audit et de rétro-ingénierie. Gratification : 1 800 € brut / mois.",
    ...
    },
    {
        ...
        "title": "STAGE M2 / PFE - Recherche et exploitation de vulnérabilités",
        "company_id": "synacktiv",
        "company_name": "Synacktiv",
        "contract_type": "Stage M2 / PFE (6 mois)",
        ...
        "is_cyber": True,
        "source": "Synacktiv (Site Officiel)",
        "description": "Au sein du pôle rétro-ingénierie : reverse engineering de produits complexes pour les évaluations de sécurité, recherche et exploitation de vulnérabilités mémoires ou logicielles (0-day/1-day), fuzzing et développement de PoC. Gratification : 1 800 € brut / mois.",
        "posted_at": "2025-10-02",
        "status": "active",
        "verification_status": "VERIFIED_ACTIVE"
    }
